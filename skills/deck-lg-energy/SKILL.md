...
전지 전문 기업으로 여는 에너지 전환를 담은 **LG Energy Solution 브랜드 테마 PPTX** 생성기. 검증된 브랜드 컬러와
...
python3 ../../_engine/render_deck.py \
  ...
  --out examples/lg-energy-6p.pptx --pdf

# 3) 검증 게이트 (PASS라야 배포)
python3 ../../_engine/validate.py examples/lg-energy-6p.pptx \
...
> ⚠️ **비공식 브랜드 영감 테마입니다.** 본 스킬은 LG Energy Solution과 제휴·보증 관계가 없으며,
> 상표·로고는 LG에너지솔루션 (LG Energy Solution Ltd.)의 자산입니다. 팔레트는 공개된 브랜드 컬러를
