...
> 카카오 (Kakao Corp.)의 자산이며, 본 리포는 로고 파일을 포함하지 않습니다.
...
`friendly rounded flat illustration, Kakao yellow with dark ink, warm minimal, no logos`
...
Kakao, 관련 로고 및 명칭은 카카오 (Kakao Corp.)의 등록상표입니다. 본 테마는 팬메이드/
